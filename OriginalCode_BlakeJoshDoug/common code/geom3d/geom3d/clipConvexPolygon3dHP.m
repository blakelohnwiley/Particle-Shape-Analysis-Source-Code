...
tic % *********************************************
% Note By Josh Knicely
% This program works very quickly and very well with planes that are
% parallel to two of the axes, but gives false intersections if not. 
