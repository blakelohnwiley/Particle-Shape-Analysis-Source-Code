...
x0 = 0; dx= 1;
y0 = 0; dy= 1; % can change dy=1 to dy=2 to make this into a rectangular prism
z0 = 0; dz= 1;
...
nodes = [...
    ...
    x0+dx y0 z0+dz; ...
    x0 y0+dy z0+dz; ...
    x0+dx y0+dy z0+dz]; % AKA the vertices

edges = [1 2;1 3;1 5;2 4;2 6;3 4;3 7;4 8;5 6;5 7;6 8;7 8]; % the numbers here refer to the pair of vertices the edge extends to, ie from 1 to 2 goes from position (0,0,0) to (1,0,0)

% faces are oriented such that normals point outwards
faces = [1 3 4 2;5 6 8 7;2 4 8 6;1 5 7 3;1 2 6 5;3 7 8 4]; % arranged so that each point (a node) creates a face by going around it. 
