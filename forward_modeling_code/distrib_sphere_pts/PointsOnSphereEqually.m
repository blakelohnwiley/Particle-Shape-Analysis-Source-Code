function [x,y,z] = PointsOnSphereEqually(NPoints)
...
% Please modify the file path  (linux based system)
% javaaddpath /export/home/gkoay/cgk.jar    

% add the jar file to the java path through javaaddpath %%%
% Adds the directory location of the jar file into matlab
% javaaddpath quotation marks must be used otherwise it will not work

% ckg.jar is in the common_code directory. Is this dir in the path?
javaaddpath('/Users/bmhannan/Documents/MATLAB/solidsProblem/projection_section_modeling/main/common_code/cgk.jar');
...
aess = AnalyticallyExactSpiralScheme();

% STEP 4 %%
% get NPoints points in Cartesian coordinates
Points = aess.getPointSetInCartesianCoordinates(NPoints);

% Access the entire array the 
% 1st column is the x coordinates 
x = Points(:,1);

%   2nd column is the y coordinates 
y = Points(:,2);

%   3rd column is the z coordinates 
z = Points(:,3);
